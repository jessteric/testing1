 ...
 */
final class Version20250406104722 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE coupon (code VARCHAR(20) NOT NULL, type VARCHAR(10) NOT NULL, value DOUBLE PRECISION NOT NULL, PRIMARY KEY(code))
        SQL);
        $this->addSql(<<<'SQL'
